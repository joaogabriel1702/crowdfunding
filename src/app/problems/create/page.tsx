...
export default function ProblemCreate() {
    ...
    const mergedLabelClasses = twMerge(defaultLabelClasses, labelStyle)
    ...
    const [state, setState] = React.useState<ProblemCreateState>({
     ...
     const handleChangeState = (updatedValue: ProblemCreateState) => {
            ...
            <div className="flex h-screen-navbar">
                ...
                <div className="flex flex-1 justify-center pl-10 pr-10 pb-10 overflow-auto">
                    <div className="mt-20 max-w-[588px] w-[100%]">
                        <TextInput onChange={(event) => handleChangeState({title: event.target.value})}
                        value={state.title}
                        labelClassNames={labelStyle} label="Título da ação" placeholder="Título da ação"/>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex gap-2 mas-w-[100%]">
